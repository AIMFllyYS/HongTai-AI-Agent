...
dependencies {
  ...
  // The community module supplies SQLCipher as a Kotlin-only dependency. It is
  // intentionally linked here rather than generated by `cap sync`, because
  // CapacitorSQLitePlugin must never be exposed to the WebView.
  implementation(project(":hongtai-community-sqlite-native"))
