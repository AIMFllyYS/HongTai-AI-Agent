...
test("the v0.1.32 candidate advances source while the published v0.1.31 download stays recommended", () => {
  ...
  // 发布状态：源码推进到 0.1.32/code 40 候选；公网推荐仍是已发布的 0.1.31/code 39，
  // v0.1.32 验收通过前不切换下载页。
