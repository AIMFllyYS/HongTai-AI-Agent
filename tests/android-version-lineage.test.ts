...
test("the published v0.1.30 download becomes recommended while v0.1.29 stays archived", () => {
  ...
  // 发布状态：源码与公网推荐一致推进到 0.1.30/code 38，v0.1.29/code 37 退回历史版本。
  assert.equal(sourceCode, 38);
  assert.equal(sourceName, "0.1.30");
