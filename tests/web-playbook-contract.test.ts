...
test("playbook catalog lists every registered section id", () => {
  ...
  assert.deepEqual(ids, ["color", "type", "icons", "tabbar", "navbar", "chrome", "overlay", "skeleton", "paste", "compose", "analysis", "settings", "recent-record-actions", "observing", "observation", "follow-up"]);
