...
> **已过期。** 写于 2026-08-16，基线 `0.1.12` / `versionCode=20`。目录、Flow 数量、插件数量、`production-plan` 版本和路由都已变化。
> 当前源码地图见 [`docs/项目架构解析.md`](../项目架构解析.md)。规则见 [`AGENTS.md`](../../AGENTS.md)，当前能做什么见[当前能力与发布状态](../当前能力与发布状态.md)。下文不再更新，只作当时快照。
