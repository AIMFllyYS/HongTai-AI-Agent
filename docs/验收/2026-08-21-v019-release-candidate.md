# v0.1.19 Release 验收记录（公网已发布，真机待验）

## 目标与范围

- 用户可感知结果：未归档设计稿的观察、设置、模板与底栏进入独立签名 Android Release，并完成公网文件回验。
...
| 公网地址 | `https://husteread.com/storage/public/HongTai-AI-Agent-release-v0.1.19.apk` |
...
2026-08-21 从 `https://husteread.com/storage/public/HongTai-AI-Agent-release-v0.1.19.apk` 重新下载，得到 23,202,490 字节、SHA-256 `b47a95f68900804c43f15ab2472d598c1e78355bce53f75a285df68aa4aaeb1b`，与本地归档 `output/apk-archive/HongTai-AI-Agent-release-v0.1.19.apk` 逐字节一致。`download.html` 现推荐该公开文件。
...
本文件记录的 `v0.1.19` 已完成固定公网地址上传，并从公网重新下载核对得到与本地归档一致的 23,202,490 字节和 SHA-256 `b47a95f68900804c43f15ab2472d598c1e78355bce53f75a285df68aa4aaeb1b`；`download.html` 现推荐公开的 `v0.1.19`。公开分发只证明文件身份和下载链路已回验，不等于物理 Android 真机、真实 AI Provider 或两条制作主链已经验收通过。
