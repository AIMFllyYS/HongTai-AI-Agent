...
export function pageSkeletonLayoutForRoute(key: RouteKey): PageSkeletonLayout {
  ...
  if (key === "settings" || key === "settings-profile" || key === "settings-ai" || key === "settings-storage" || key === "settings-storage-area" || key === "settings-app-info" || key === "settings-update-log") return "settings";
